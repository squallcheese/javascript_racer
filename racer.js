$(document).ready(function(){
  ...
  var race_restart = function() {
    ...
    $("tr#player1_strip > td.active").removeClass();
    $("tr#player1_strip td:first-child").addClass("active");
    $("tr#player2_strip > td.active").removeClass();
    $("tr#player2_strip td:first-child").addClass("active");
  };
